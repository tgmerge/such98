...
/**
 *  Usage:
 *      new APIUtil.PostTopicPost(this, 2803718, "title", "content", new APIUtil.APICallback() {
 *          @ Override
...
public final class APIUtil {
    ...
    public abstract static class APIRequest {
        ...
        public APIRequest(Context ctx, APICallback callback) {
            ...
            class MyAPIHandler extends AsyncHttpResponseHandler {
                ...
                public void onFailure(final int statCode, final Header[] headers, final byte[] body, final Throwable error) {
                    ...
                    if (statCode == 401) { // todo Stronger test, maybe body == Unauthorized
                        OAuthUtil.OAuthManager oam = OAuthUtil.newOAuthManager(mCtx);
                        if (oam == null) {
    ...
    public static final class GetNewTopic extends APIRequest {
        public GetNewTopic(Context ctx, Integer pageFrom, Integer pageTo, Integer pageSize, APICallback callback) {
            super(ctx, callback);
    ...
    public static final class GetBoardTopic extends APIRequest {
        public GetBoardTopic(Context ctx, int boardId, Integer pageFrom, Integer pageTo, Integer pageSize, APICallback callback) {
            super(ctx, callback);
    ...
    public final static class GetHotTopic extends APIRequest {
        public GetHotTopic(Context ctx, Integer pageFrom, Integer pageTo, Integer pageSize, APICallback callback) {
            super(ctx, callback);
    ...
    public static final class PostBoardTopic extends APIRequest {
        public PostBoardTopic(Context ctx, int boardId, String title, String content, APICallback callback) {
            super(ctx, callback);
    ...
    public static final class GetTopic extends APIRequest {
        public GetTopic(Context ctx, int topicId, APICallback callback) {
            super(ctx, callback);
    ...
    public static final class GetTopicPost extends APIRequest {
        public GetTopicPost(Context ctx, int topicId, Integer pageFrom, Integer pageTo, Integer pageSize, APICallback callback) {
            super(ctx, callback);
    ...
    public static final class GetPost extends APIRequest {
        public GetPost(Context ctx, int postId, APICallback callback) {
            super(ctx, callback);
    ...
    public static final class PostTopicPost extends APIRequest {
        public PostTopicPost(Context ctx, int topicId, String title, String content, APICallback callback) {
            super(ctx, callback);
    ...
    public static final class PutPost extends APIRequest {
        public PutPost(Context ctx, int postId, String title, String content, APICallback callback) {
            super(ctx, callback);
            this.setURL(URL_CC98API + "Post/" + postId);
            this.addParam("Title", title);
            this.addParam("Content", content);
    ...
    public static final class GetNameUser extends APIRequest {
        public GetNameUser(Context ctx, String userName, APICallback callback) {
            super(ctx, callback);
    ...
    public static final class GetIdUser extends APIRequest {
        public GetIdUser(Context ctx, int userId, APICallback callback) {
            super(ctx, callback);
    ...
    public static final class GetRootBoard extends APIRequest {
        public GetRootBoard(Context ctx, Integer pageFrom, Integer pageTo, Integer pageSize, APICallback callback) {
            super(ctx, callback);
    ...
    public static final class GetSubBoards extends APIRequest {
        public GetSubBoards(Context ctx, int boardId, Integer pageFrom, Integer pageTo, Integer pageSize, APICallback callback) {
            super(ctx, callback);
    ...
    public static final class GetBoard extends APIRequest {
        public GetBoard(Context ctx, int boardId, APICallback callback) {
            super(ctx, callback);
    ...
    public static final class GetMultiBoards extends APIRequest {
        public GetMultiBoards(Context ctx, int[] boardIds, Integer pageFrom, Integer pageTo, Integer pageSize, APICallback callback) {
            super(ctx, callback);
            String idPart = "";
    ...
    public static final class GetBasicMe extends APIRequest {
        public GetBasicMe(Context ctx, APICallback callback) {
            super(ctx, callback);
    ...
    public static final class GetCustomBoardsMe extends APIRequest {
        public GetCustomBoardsMe(Context ctx, APICallback callback) {
            super(ctx, callback);
    ...
    public static final class GetMe extends APIRequest {
        public GetMe(Context ctx, APICallback callback) {
            super(ctx, callback);
    ...
    public static final class PutMe extends APIRequest {
        public PutMe(Context ctx, String data, APICallback callback) {
            super(ctx, callback);
            this.setURL(URL_CC98API + "Me");
    ...
    public static final class GetSystemSetting extends APIRequest {
        public GetSystemSetting(Context ctx, APICallback callback) {
            super(ctx, callback);
    ...
    public static final class GetMessage extends APIRequest {
        public GetMessage(Context ctx, int messageId, APICallback callback) {
            super(ctx, callback);
    ...
    public static final class GetUserMessage extends APIRequest {
        ...
        public GetUserMessage(Context ctx, String userName, int filter, Integer pageFrom, Integer pageTo, Integer pageSize, APICallback callback) {
            super(ctx, callback);
    ...
    public static final class DeleteMessage extends APIRequest {
        public DeleteMessage(Context ctx, int messageId, APICallback callback) {
            super(ctx, callback);
            this.setURL(URL_CC98API + "Message/" + messageId);
            this.addAuthorization();
        }
    ...
    public static final class PutMessage extends APIRequest {
        public PutMessage(Context ctx, int messageId, String receiverName, String title, String content, APICallback callback) {
            super(ctx, callback);
            this.setURL(URL_CC98API + "Message/" + messageId);
    ...
    public static final class PostMessage extends APIRequest {
        public PostMessage(Context ctx, String receiverName, String title, String content, APICallback callback) {
            super(ctx, callback);
